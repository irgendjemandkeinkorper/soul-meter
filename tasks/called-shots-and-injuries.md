...
**Status:** Accuracy foundation (task 2) verified 2026-09-18; lab aimed attack (task 3) and HUD aim selection (task 4) and line-of-fire/exposure (task 5), physical visibility (task 6), bounded location injury (task 7), throat/vocal integration (task 8), persistent serious injuries (task 9), the atomic treatment operation (task 10A), and the healer service interaction (task 10B) implemented 2026-09-19; Checkpoint B reached. Field treatment (10C), content, and AI remain planned.
