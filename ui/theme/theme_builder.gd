...
static func build() -> Theme:
	...
	# Character creation Form 7: every wizard page uses these semantic layout and
	# frame variations so dynamically-built controls carry no local style overrides.
	t.add_type("ChargenStepRail")
	t.set_type_variation("ChargenStepRail", "HBoxContainer")
	t.set_constant("separation", "ChargenStepRail", DS.SPACE_3)
	t.add_type("ChargenStepMarker")
	t.set_type_variation("ChargenStepMarker", "Label")
	t.set_font("font", "ChargenStepMarker", numeric)
	t.set_font_size("font_size", "ChargenStepMarker", DS.FS_100)
	t.set_color("font_color", "ChargenStepMarker", DS.ASH_DIM)
	t.add_type("ChargenPage")
	t.set_type_variation("ChargenPage", "HBoxContainer")
	t.set_constant("separation", "ChargenPage", DS.SPACE_8)
	t.add_type("ChargenIllustrationFrame")
	t.set_type_variation("ChargenIllustrationFrame", "PanelContainer")
	t.set_stylebox("panel", "ChargenIllustrationFrame", _notched_style(27, DS.SPACE_8))
	t.add_type("ChargenIllustrationColumn")
	t.set_type_variation("ChargenIllustrationColumn", "VBoxContainer")
	t.set_constant("separation", "ChargenIllustrationColumn", DS.SPACE_6)
	t.add_type("ChargenIllustrationTitle")
	t.set_type_variation("ChargenIllustrationTitle", "Label")
	t.set_font("font", "ChargenIllustrationTitle", display)
	t.set_font_size("font_size", "ChargenIllustrationTitle", DS.FS_500)
	t.set_color("font_color", "ChargenIllustrationTitle", DS.GILD_2)
	t.add_type("ChargenFormColumn")
	t.set_type_variation("ChargenFormColumn", "VBoxContainer")
	t.set_constant("separation", "ChargenFormColumn", DS.SPACE_5)
	t.add_type("ChargenChoiceButton")
	t.set_type_variation("ChargenChoiceButton", "Button")
	t.set_stylebox("normal", "ChargenChoiceButton", _notched_style(26, DS.SPACE_4))
	t.set_stylebox("hover", "ChargenChoiceButton", _notched_style(28, DS.SPACE_4))
	t.set_stylebox("pressed", "ChargenChoiceButton", _notched_style(29, DS.SPACE_4))
	t.set_stylebox("focus", "ChargenChoiceButton", _notched_style(29, DS.SPACE_4))
	t.set_stylebox("disabled", "ChargenChoiceButton", _notched_style(30, DS.SPACE_4))
	t.add_type("ChargenPortraitButton")
	t.set_type_variation("ChargenPortraitButton", "Button")
	t.set_stylebox("normal", "ChargenPortraitButton", _notched_style(26, DS.SPACE_2))
	t.set_stylebox("hover", "ChargenPortraitButton", _notched_style(28, DS.SPACE_2))
	t.set_stylebox("pressed", "ChargenPortraitButton", _notched_style(29, DS.SPACE_2))
	t.set_stylebox("focus", "ChargenPortraitButton", _notched_style(29, DS.SPACE_2))
	t.add_type("ChargenSummaryText")
	t.set_type_variation("ChargenSummaryText", "Label")
	t.set_font("font", "ChargenSummaryText", numeric)
	t.set_font_size("font_size", "ChargenSummaryText", DS.FS_200)
	t.add_type("ChargenValidationLabel")
	t.set_type_variation("ChargenValidationLabel", "Label")
	t.set_font("font", "ChargenValidationLabel", quote)
	t.set_color("font_color", "ChargenValidationLabel", DS.GILD_2)
	...
	# Registry-driven world map. Screen nodes only select these semantic roles;
	# route and marker geometry remains in the map control and uses DS tokens.
	t.add_type("WorldMapColumns")
	t.set_type_variation("WorldMapColumns", "HBoxContainer")
	t.set_constant("separation", "WorldMapColumns", DS.CONTROL_GAP)
	t.add_type("WorldMapField")
	t.set_type_variation("WorldMapField", "PanelContainer")
	t.set_stylebox("panel", "WorldMapField", _notched_style(19, DS.SPACE_2))
	t.add_type("WorldMapSidebar")
	t.set_type_variation("WorldMapSidebar", "PanelContainer")
	t.set_stylebox("panel", "WorldMapSidebar", _notched_style(27, DS.PANEL_PAD))
	t.add_type("WorldMapMarker")
	t.set_type_variation("WorldMapMarker", "Button")
	t.set_stylebox("normal", "WorldMapMarker", _notched_style(21, DS.SPACE_3, DS.SPACE_4))
	t.set_stylebox("hover", "WorldMapMarker", _notched_style(22, DS.SPACE_3, DS.SPACE_4))
	t.set_stylebox("pressed", "WorldMapMarker", _notched_style(23, DS.SPACE_3, DS.SPACE_4))
	t.set_stylebox("focus", "WorldMapMarker", _notched_style(23, DS.SPACE_3, DS.SPACE_4))
	t.add_type("WorldMapCurrentMarker")
	t.set_type_variation("WorldMapCurrentMarker", "Button")
	t.set_stylebox("disabled", "WorldMapCurrentMarker", _notched_style(17, DS.SPACE_3, DS.SPACE_4))
	t.set_color("font_disabled_color", "WorldMapCurrentMarker", DS.TEXT_ON_METAL)
	t.add_type("WorldMapUndiscoveredMarker")
	t.set_type_variation("WorldMapUndiscoveredMarker", "Button")
	t.set_stylebox("disabled", "WorldMapUndiscoveredMarker", _notched_style(14, DS.SPACE_3, DS.SPACE_4))
	t.set_color("font_disabled_color", "WorldMapUndiscoveredMarker", DS.ASH_FAINT)
	t.add_type("WorldMapPartyMarker")
	t.set_type_variation("WorldMapPartyMarker", "PanelContainer")
	t.set_stylebox("panel", "WorldMapPartyMarker", _notched_style(18, DS.SPACE_2, DS.SPACE_3))
	t.add_type("WorldMapPartyLabel")
	t.set_type_variation("WorldMapPartyLabel", "Label")
	t.set_font("font", "WorldMapPartyLabel", display)
	t.set_font_size("font_size", "WorldMapPartyLabel", DS.FS_100)
	t.set_color("font_color", "WorldMapPartyLabel", DS.TEXT_ON_METAL)
	t.add_type("WorldMapLegend")
	t.set_type_variation("WorldMapLegend", "Label")
	t.set_font("font", "WorldMapLegend", display)
	t.set_font_size("font_size", "WorldMapLegend", DS.FS_100)
	t.set_color("font_color", "WorldMapLegend", DS.ASH)
	t.add_type("JourneyEncounterPanel")
	t.set_type_variation("JourneyEncounterPanel", "PanelContainer")
	t.set_stylebox("panel", "JourneyEncounterPanel", _notched_style(15, DS.PANEL_PAD))
