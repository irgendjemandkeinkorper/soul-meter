...
- **CI wiring for gdUnit4** — the suite runs manually today; no pipeline invokes it yet. The
  GLoot generator's `SOUL_METER_DRIFT_CHECK=1` headless pattern (above) is the template to
