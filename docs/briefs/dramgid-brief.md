...
| `SKILL.UNDERTONE` | Undertone | Intuition | Insight; fully Loom-sensitive and can misread Nul-tainted targets. `../dramgid-mono/00-governance/rfcs/imports/ledger/RFC-0004-dramgid-attributes-skills.md:161-163` `../dramgid-mono/00-governance/rfcs/imports/ledger/RFC-0005-dramgid-absorbs-legacy-attributes.md:181` |
