...
Light fields), `__jams__` (successful Jams by requester and round) and `__impositions__`
(Burning/Soaked/Exposed/Veiled/Lit per combat id), all omitted when empty so older saves load
unchanged.
