...
1. ~~**Where is she held?**~~ **ANSWERED [CANON 2026-08-24]** — reframed first: the kidnapping premise is superseded by the vault re-canon (Maiiam is Rhea, withdrawing deliberately; her withdrawal IS the Waning; "where she goes when she finishes leaving" is a permanent do-not-solve mystery). The surviving game question — Act III's final destination — is ratified: **the Still Forge beneath Karrn-Vash**, the one structure Maiiam and Vicoar raised in tandem, the only place both halves of the split being touch. The finale is **layered**: worshipped-Maiiam (the belief-fed egregore mask) is the dungeon's guardian and false ending; cosmic Maiiam, mid-exit, waits behind it for the true choice. Tone: **elegiac / funeral** — a leave-taking, not a battle; the player walks through what the world loses. (Vault: `locations/karrn-vash.md`, `deities/maiiam.md`.)
2. ~~**How long has she been fading?**~~ **ANSWERED BY VAULT** — the Waning's true origin (the Kes'reth emergence at Verleidenlot) is **five to seven centuries** in the past; symptoms turned undeniable only in the present age (~1000 AB). Grief-become-doctrine has had generations. See vault `cosmology/the-waning.md`, `eras/present-age.md`.
3. ~~**The other nine gods:**~~ **ANSWERED [CANON 2026-08-24]** — **divided, and mostly wrong.** No god knows the withdrawal is deliberate; each reads the Waning through its own doctrine (the Flamebinders forge harder, the Cold Consensus calls it vindication, Vhorr calls it compost). The player can recruit at most **one god's faction, never a god** — by proving that doctrine wrong. ("Who suspects Pazzah is Kronos" remains a listed vault mystery — untouched.)
4. ~~**The devils:**~~ **SUPERSEDED BY VAULT** — Harem Stet is re-canonized as the Master of the Larder of the **Cold Consensus** (undead preservationist triad, Wintervast); no devils stand behind him. Devil questions now run through the vault's Deivelsgracht-pact / Axion's-Deal open questions, which stay open there.
5. ~~**Agars Reys:**~~ **SUPERSEDED BY VAULT** — no such entity survives the re-canon; demon-adjacent cosmology now runs through the Weft/Underweave question and the Breach (see vault `canon/open-questions.md`, `orlaganna/lords-of-the-breach`). Do not reintroduce the bible framing.
6. ~~**The Harem Stet pivot branches:**~~ **ANSWERED [CANON 2026-08-24]** — **all three ship** (ally / shatter / refuse), each a permanent world-mark. Placement: **Chapter 1 foreshadows** (cheap hooks — a correspondent NPC, rumors of the "kindest offer"); the **Wintervast encounter itself is Act II** region content behind the playtest gate.
7. ~~**Race count (bible Q3):**~~ **ANSWERED BY VAULT + CHARGEN** — the vault's peoples roster is the pool; the playable pick is the ratified chargen ancestry set (`globals/chargen_data.gd` ANCESTRIES, per #98). No Tiefling stand-in exists post-re-canon.
8. ~~**Timeline (bible Q7):**~~ **ANSWERED BY VAULT** — present age ≈ **1000 AB** (After Bloom); see vault `eras/`.
9. ~~**Does Baes-as-Maiiam retain anything of Baes?**~~ **REFRAMED + ANSWERED [CANON 2026-08-24]** — no prison-door scene survives (vault: Rhea split herself into Maiiam and Vicoar; Baes Kuchnik is the mortal who spoke her name). The surviving question — the melody (bible Q9) — is ratified as a **motif**: a recurring audible theme through the game that plays fully, transformed, at the Still Forge finale.
10. ~~**The new entity from Act V of the novel** (bible Q8)~~ **ANSWERED [CANON 2026-08-24]** — an **ending wildcard**: absent from the world until the finale, appearing only as one of the "further outcomes" the Still Forge choice can unlock. No Era 3 presence to author before Act III.
11. ~~**Has wielding chaos changed Kronos?**~~ **ANSWERED [CANON 2026-08-24]** — **hint, never state.** Environmental/dialogue hints that the mask bleeds into the wearer (drifting Pazzah iconography, ordered rites producing small wrongness); no text ever confirms it. Presentation rule, not vault prose.
